...
plugins {
    ...
    // Native Lean lexer (JFlex) + skeleton parser/PSI (Grammar-Kit) code generation.
...
sourceSets {
    main {
        // src/gen/java holds the JFlex/Grammar-Kit generated lexer + parser + PSI (regenerated by the gen tasks).
...
tasks {
    ...
    val genLean4Lexer = register<GenerateLexerTask>("genLean4Lexer") {
        description = "Generates the Lean 4 lexer"
        group = "build setup"
    ...
    val genLean4Parser = register<GenerateParserTask>("genLean4Parser") {
        description = "Generates the Lean 4 skeleton parser + PSI"
        group = "build setup"
